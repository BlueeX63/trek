...
export const kareriLakeDetails: DetailedTrek = {
  slug: "kareri-lake",
  name: "Kareri Lake Trek",
  location: "Kareri Village",
  duration: "3 Days",
  maxAltitude: "9700 FT",
  distance: "26 km",
  grade: "Easy",
  ...
  howToReach: {
    meetingPlace: "Designated pickup point at Pathankot is the nearest rail head to the base camp or Kangra Gaggal Airport which is 13km away from Dharamshla",
    dropOff: "Same as meeting place",
    options: [
      "Take an overnight bus from major nearby cities.",
      "Take a train to Pathankot is the nearest rail head to the base camp.",
      "Fly into Kangra Gaggal Airport which is 13km away from Dharamshla a day in advance."
    ]
  },
  costTerms: {
    inclusions: [
  ...
  faqs: [
    {
      question: "What is the best time to do the Kareri Lake Trek?",
      answer: "The best time to do the Kareri Lake Trek is typically during the Summer | Autumn season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Kareri Lake Trek?",
      answer: "The Kareri Lake Trek is graded as Easy. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Kareri Lake Trek is 9700 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 9700 FT."
    }
  ]
};
