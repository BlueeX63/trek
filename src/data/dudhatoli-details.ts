...
export const dudhatoliDetails: DetailedTrek = {
  slug: "dudhatoli",
  name: "Dudhatoli Trek",
  location: "Peethsain",
  duration: "5 Days",
  ...
  image: "/images/uttarakhand/dudhatoli.webp",
  overview: {
    description: [
      "The Dudhatoli Trek is not just a trek; it's an immersive experience into the heart of the wild. Designed for those who seek both challenge and beauty, this trail promises spectacular panoramic vistas at every turn. It is the perfect escape to reconnect with nature in its most pristine and powerful form.",
  ...
  howToReach: {
    meetingPlace: "Designated pickup point at Dehradun or Jolly Grant Airport, which is 21 km away from Rishikesh",
  ...
  faqs: [
    {
      question: "What is the best time to do the Dudhatoli Trek?",
      answer: "The best time to do the Dudhatoli Trek is typically during the Summer | Autumn season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Dudhatoli Trek?",
      answer: "The Dudhatoli Trek is graded as Easy. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Dudhatoli Trek is 9982 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 9982 FT."
    }
  ]
};
