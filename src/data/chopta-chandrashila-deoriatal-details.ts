...
export const choptaChandrashilaDeoriatalDetails: DetailedTrek = {
  slug: "chopta-chandrashila-deoriatal",
  name: "Chopta Chandrashila Tungnath Trek with Deoriatal",
  ...
  faqs: [
    {
      question: "What is the best time to do the Chopta Chandrashila Tungnath Trek with Deoriatal?",
      answer: "The best time to do the Chopta Chandrashila Tungnath Trek with Deoriatal is typically during the Spring | Summer | Autumn | Winter season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Chopta Chandrashila Tungnath Trek with Deoriatal?",
      answer: "The Chopta Chandrashila Tungnath Trek with Deoriatal is graded as Easy to Moderate. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Chopta Chandrashila Tungnath Trek with Deoriatal is 12000 FT."
    },
    {
