...
export const pinBhabaPassDetails: DetailedTrek = {
  ...
  faqs: [
    {
      question: "What is the best time to do the Pin Bhaba Pass Trek?",
      answer: "The best time to do the Pin Bhaba Pass Trek is typically during the Monsoon season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Pin Bhaba Pass Trek?",
      answer: "The Pin Bhaba Pass Trek is graded as Moderate to Difficult. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Pin Bhaba Pass Trek is 16100 FT."
    },
    {
