...
export const aliBedniBugyalDetails: DetailedTrek = {
  ...
  faqs: [
    {
      ...
      answer: "The best time to do the Ali Bedni Bugyal Trek is typically during the Spring | Summer | Autumn | Winter season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Ali Bedni Bugyal Trek?",
      answer: "The Ali Bedni Bugyal Trek is graded as Moderate. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Ali Bedni Bugyal Trek is 12500 FT."
    },
    {
