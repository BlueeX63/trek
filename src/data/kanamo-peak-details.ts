...
export const kanamoPeakDetails: DetailedTrek = {
  slug: "kanamo-peak",
  name: "Kanamo Peak Trek Expedition",
  location: "Manali",
  duration: "8 Days",
  maxAltitude: "19553 FT",
  distance: "27 km",
  grade: "Difficult",
  ...
  image: '/images/himachal/kanamo-peak.jpg',
  overview: {
    description: [
      "The Kanamo Peak Trek Expedition is not just a trek; it's an immersive experience into the heart of the wild. Designed for those who seek both challenge and beauty, this trail promises spectacular panoramic vistas at every turn. It is the perfect escape to reconnect with nature in its most pristine and powerful form.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 19553 FT."
    }
  ]
};
