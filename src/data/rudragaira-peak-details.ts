...
export const rudragairaPeakDetails: DetailedTrek = {
  slug: "rudragaira-peak",
  name: "Rudragaira Peak Expedition",
  location: "Gangotri",
  duration: "13 Days",
  maxAltitude: "19086 FT",
  distance: "50 km",
  grade: "Challenging",
  ...
  faqs: [
    {
      question: "What is the best time to do the Rudragaira Peak Expedition?",
      answer: "The best time to do the Rudragaira Peak Expedition is typically during the Summer | Autumn season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Rudragaira Peak Expedition?",
      answer: "The Rudragaira Peak Expedition is graded as Challenging. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Rudragaira Peak Expedition is 19086 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 19086 FT."
    }
  ]
};
