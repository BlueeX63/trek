...
export const bagjiBugyalDetails: DetailedTrek = {
  slug: "bagji-bugyal",
  name: "Bagji Bugyal Trek",
  location: "Ghase Village",
  duration: "6 Days",
  maxAltitude: "11100 FT",
  distance: "24 km",
  grade: "Easy",
  price: 15000, // Default placeholder
  baseCamp: "Ghase Village",
  ...
  faqs: [
    {
      question: "What is the best time to do the Bagji Bugyal Trek?",
      answer: "The best time to do the Bagji Bugyal Trek is typically during the Spring | Summer | Autumn | Winter season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Bagji Bugyal Trek?",
      answer: "The Bagji Bugyal Trek is graded as Easy. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Bagji Bugyal Trek is 11100 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 11100 FT."
    }
  ]
};
