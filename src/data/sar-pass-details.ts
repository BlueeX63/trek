...
export const sarPassDetails: DetailedTrek = {
  slug: "sar-pass",
  name: "Sar Pass Trek",
  location: "Kasol",
  duration: "5 Days",
  maxAltitude: "13600 FT",
  distance: "33 km",
  grade: "Moderate",
  ...
  image: '/images/himachal/sar-pass.jpg',
  overview: {
    description: [
      "The Sar Pass Trek is not just a trek; it's an immersive experience into the heart of the wild. Designed for those who seek both challenge and beauty, this trail promises spectacular panoramic vistas at every turn. It is the perfect escape to reconnect with nature in its most pristine and powerful form.",
  ...
  faqs: [
    {
      question: "What is the best time to do the Sar Pass Trek?",
      answer: "The best time to do the Sar Pass Trek is typically during the Summer season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Sar Pass Trek?",
      answer: "The Sar Pass Trek is graded as Moderate. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Sar Pass Trek is 13600 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 13600 FT."
    }
  ]
};
