...
export const friendshipPeakDetails: DetailedTrek = {
  slug: "friendship-peak",
  name: "Friendship Peak Expedition",
  location: "Manali",
  duration: "7 Days",
  maxAltitude: "17346 FT",
  distance: "24 km",
  grade: "Challenging",
  ...
  faqs: [
    {
      question: "What is the best time to do the Friendship Peak Expedition?",
      answer: "The best time to do the Friendship Peak Expedition is typically during the Summer | Monsoon | Autumn season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Friendship Peak Expedition?",
      answer: "The Friendship Peak Expedition is graded as Challenging. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Friendship Peak Expedition is 17346 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 17346 FT."
    }
  ]
};
