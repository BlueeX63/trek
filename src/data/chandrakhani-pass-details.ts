...
export const chandrakhaniPassDetails: DetailedTrek = {
  ...
  howToReach: {
    meetingPlace: "Designated pickup point at Pathankot is the nearest rail head to the base camp or Bhuntar, which is 52 km away from Manali",
  ...
  faqs: [
    {
      question: "What is the best time to do the Chandrakhani Pass Trek?",
      answer: "The best time to do the Chandrakhani Pass Trek is typically during the Summer | Monsoon season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Chandrakhani Pass Trek?",
      answer: "The Chandrakhani Pass Trek is graded as Easy to Moderate. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Chandrakhani Pass Trek is 12100 FT."
    },
    {
