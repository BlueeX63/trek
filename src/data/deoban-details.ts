...
export const deobanDetails: DetailedTrek = {
  slug: "deoban",
  ...
  image: "/images/uttarakhand/deoban.jpg",
  overview: {
    description: [
      "The Deoban Weekend Trek is not just a trek; it's an immersive experience into the heart of the wild. Designed for those who seek both challenge and beauty, this trail promises spectacular panoramic vistas at every turn. It is the perfect escape to reconnect with nature in its most pristine and powerful form.",
  ...
  faqs: [
    {
      question: "What is the best time to do the Deoban Weekend Trek?",
      answer: "The best time to do the Deoban Weekend Trek is typically during the Spring | Autumn | Winter season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Deoban Weekend Trek?",
      answer: "The Deoban Weekend Trek is graded as Easy. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Deoban Weekend Trek is 9500 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 9500 FT."
    }
  ]
};
