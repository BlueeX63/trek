...
export const ranthanKharakDetails: DetailedTrek = {
  slug: "ranthan-kharak",
  ...
  image: "/images/uttarakhand/ranthan-kharak.jpg",
  overview: {
    description: [
      "The Ranthan Kharak Trek is not just a trek; it's an immersive experience into the heart of the wild. Designed for those who seek both challenge and beauty, this trail promises spectacular panoramic vistas at every turn. It is the perfect escape to reconnect with nature in its most pristine and powerful form.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 12900 FT."
    }
  ]
};
