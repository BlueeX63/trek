...
export const doditalDarwaPassDetails: DetailedTrek = {
  slug: "dodital-darwa-pass",
  name: "Dodital Darwa Pass Trek",
  location: "Uttarkashi",
  duration: "7 Days",
  maxAltitude: "11400 FT",
  distance: "50 km",
  grade: "Moderate",
  ...
  faqs: [
    {
      question: "What is the best time to do the Dodital Darwa Pass Trek?",
      answer: "The best time to do the Dodital Darwa Pass Trek is typically during the Summer | Autumn season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Dodital Darwa Pass Trek?",
      answer: "The Dodital Darwa Pass Trek is graded as Moderate. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Dodital Darwa Pass Trek is 11400 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 11400 FT."
    }
  ]
};
