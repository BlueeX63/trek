...
export const kuariPassDetails: DetailedTrek = {
  slug: "kuari-pass",
  name: "Kuari Pass Trek",
  location: "Pipalkoti",
  duration: "6 Days",
  maxAltitude: "12750 FT",
  distance: "27 km",
  grade: "Moderate",
  ...
  faqs: [
    {
      question: "What is the best time to do the Kuari Pass Trek?",
      answer: "The best time to do the Kuari Pass Trek is typically during the Spring | Summer | Autumn | Winter season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Kuari Pass Trek?",
      answer: "The Kuari Pass Trek is graded as Moderate. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Kuari Pass Trek is 12750 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 12750 FT."
    }
  ]
};
