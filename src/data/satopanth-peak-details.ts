...
export const satopanthPeakDetails: DetailedTrek = {
  slug: "satopanth-peak",
  name: "Satopanth Peak Expedition",
  location: "Gangotri",
  duration: "22 Days",
  maxAltitude: "23210 FT",
  distance: "79 km",
  grade: "Challenging",
  ...
  faqs: [
    {
      question: "What is the best time to do the Satopanth Peak Expedition?",
      answer: "The best time to do the Satopanth Peak Expedition is typically during the Summer | Autumn season. It offers the most stable weather and clearest views."
    },
    {
      question: "How difficult is the Satopanth Peak Expedition?",
      answer: "The Satopanth Peak Expedition is graded as Challenging. Prior fitness preparation is highly recommended to comfortably enjoy the trail."
    },
    {
      question: "What is the maximum altitude reached?",
      answer: "The maximum altitude reached during the Satopanth Peak Expedition is 23210 FT."
    },
    {
    ...
    },
    {
      ...
      answer: "You will reach a maximum altitude of 23210 FT."
    }
  ]
};
