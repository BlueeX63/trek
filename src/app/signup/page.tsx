...
export default function SignUp() {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Since backend automatically verified and created the user, we just log them in to get a session!
      ...
      >
        <div className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-serif text-[var(--color-ink)] mb-4 tracking-tight">
            {step === "form" ? <>Join <span className="italic font-light">Us</span></> : <>Verify <span className="italic font-light">Email</span></>}
          </h1>
          <p className="text-sm font-sans tracking-[0.2em] uppercase text-[var(--color-ink)]/50">
            {step === "form" ? "Start Your Adventure" : "Enter the 6-digit code"}
          </p>
        </div>
